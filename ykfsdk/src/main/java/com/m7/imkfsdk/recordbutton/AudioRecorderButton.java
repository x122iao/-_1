...
public class AudioRecorderButton extends AppCompatButton implements AudioManager.AudioStateListener {
    ...
    public AudioRecorderButton(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            dir = IMChatManager.getInstance().getApplicationAgain().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS) + File.separator + "m7_chat_recorder/";
        } else {
            dir = Environment.getExternalStorageDirectory() + "/m7_chat_recorder";
        }
