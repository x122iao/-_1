...
public class AlignTextView extends TextView {
    ...
    private final List<String> lines = new ArrayList<String>(); // 分割后的行
    private final List<Integer> tailLines = new ArrayList<Integer>(); // 尾行
    ...
    public AlignTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ykfsdk_AlignTextView);

        int alignStyle = ta.getInt(R.styleable.ykfsdk_AlignTextView_ykfsdk_align, 1);
        switch (alignStyle) {
            case 1:
