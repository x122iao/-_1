...
public class ProgressLineView extends View {
    ...
    private final int PAINTSTROKEWIDTH = DensityUtil.dp2px(1f);
    private final int STARTX = DensityUtil.dp2px(15f);
    private final int TOPLINELENGTH = DensityUtil.dp2px(15f);
    private final int RADIUS = DensityUtil.dp2px(4f);
