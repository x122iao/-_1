...
//        initColors(0xFFFFFFFF, 0xFFFFFFFF);
    ...
    public PointBottomView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ykfsdk_PointBottomView);

        try {
            // Retrieve the colors to be used for this view and apply them.
            int fillColor = a.getColor(R.styleable.ykfsdk_PointBottomView_ykfsdk_fillColor,
                    0xFFFFFFFF);
            int strokeColor = a.getColor(
                    R.styleable.ykfsdk_PointBottomView_ykfsdk_strokeColor, 0xFFD9D9D9);
            // Retrieve the radius
            radius = (int) a.getDimension(R.styleable.ykfsdk_PointBottomView_ykfsdk_radius,
                    radius);
            circleInterval = (int) a.getDimension(
                    R.styleable.ykfsdk_PointBottomView_ykfsdk_circleInterval, radius);
