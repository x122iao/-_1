...
public class MoorDragCloseHelper {
    ...
    public MoorDragCloseHelper(Context mContext) {
    ...
    public void exitWithTranslation(float currentY) {
        ...
        anim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                ((Activity) mContext).overridePendingTransition(R.anim.ykfsdk_dchlib_anim_empty, R.anim.ykfsdk_dchlib_anim_alpha_out_long_time);
            }
