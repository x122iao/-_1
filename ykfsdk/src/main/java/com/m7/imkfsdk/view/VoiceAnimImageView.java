...
public class VoiceAnimImageView extends TextView {
	...
	public void initAnimImageView() {
		...
		Drawable chattingFDrawale1 = getResources().getDrawable(R.drawable.ykfsdk_kf_chatfrom_voice_playing_f1);
		...
		Drawable chattingFDrawale2 = getResources().getDrawable(R.drawable.ykfsdk_kf_chatfrom_voice_playing_f2);
		...
		Drawable chattingFDrawale3 = getResources().getDrawable(R.drawable.ykfsdk_kf_chatfrom_voice_playing_f3);
		...
		Drawable chattingTDrawable_1 = getResources().getDrawable(R.drawable.ykfsdk_kf_chatto_voice_playing_f1);
		...
		Drawable chattingTDrawable_2 = getResources().getDrawable(R.drawable.ykfsdk_kf_chatto_voice_playing_f2);
		...
		Drawable chattingTDrawable_3 = getResources().getDrawable(R.drawable.ykfsdk_kf_chatto_voice_playing_f3);
	...
	public final void startVoiceAnimation() {
		...
		case TYPE_VOICE_DOWNLOADING:
			...
			if(isFrom) {
				setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.ykfsdk_ykf_receive_msg_bg));
			} else {
				setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.ykfsdk_ykf_receive_msg_bg));
			}
