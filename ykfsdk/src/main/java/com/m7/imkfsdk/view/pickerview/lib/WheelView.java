...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.ykfsdk_pickerview_wheelview_textcolor_out);
        textColorCenter = getResources().getColor(R.color.ykfsdk_pickerview_wheelview_textcolor_center);
        dividerColor = getResources().getColor(R.color.ykfsdk_pickerview_wheelview_textcolor_divider);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.ykfsdk_pickerview_textsize);
        customTextSize = getResources().getBoolean(R.bool.ykfsdk_pickerview_customTextSize);
        if (attrs != null) {
