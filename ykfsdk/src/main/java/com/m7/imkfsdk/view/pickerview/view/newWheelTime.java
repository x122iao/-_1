...
public class newWheelTime {
    ...
    public newWheelTime(View view, boolean[] type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        //wv_hours.setLabel(context.getString(R.strings.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_mins = view.findViewById(R.id.min);
        wv_mins.setAdapter(new NumericWheelAdapter(0, 59));
        //wv_mins.setLabel(context.getString(R.strings.pickerview_minutes));// 添加文字
        wv_mins.setCurrentItem(m);
        wv_mins.setGravity(gravity);

        wv_seconds = view.findViewById(R.id.second);
        wv_seconds.setAdapter(new NumericWheelAdapter(0, 59));
        //wv_seconds.setLabel(context.getString(R.strings.pickerview_minutes));// 添加文字
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        /*wv_year.setLabel(context.getString(R.strings.pickerview_year));// 添加文字*/
     ...
     /*   wv_month.setLabel(context.getString(R.strings.pickerview_month));*/
       ...
       /* wv_day.setLabel(context.getString(R.strings.pickerview_day));*/
      ...
      /*  wv_hours.setLabel(context.getString(R.strings.pickerview_hours));// 添加文字*/
       ...
       /* wv_mins.setLabel(context.getString(R.strings.pickerview_minutes));// 添加文字*/
        ...
        wv_seconds = view.findViewById(R.id.second);
        wv_seconds.setAdapter(new NumericWheelAdapter(0, 59));
       /* wv_seconds.setLabel(context.getString(R.strings.pickerview_seconds));// 添加文字*/
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string.ykfsdk_pickerview_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.ykfsdk_pickerview_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string.ykfsdk_pickerview_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.ykfsdk_pickerview_hours));
        }
        if (label_mins != null) {
            wv_mins.setLabel(label_mins);
        } else {
            wv_mins.setLabel(view.getContext().getString(R.string.ykfsdk_pickerview_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string.ykfsdk_pickerview_seconds));
        }
