 ...
 * @author 小嵩
 */
final class newSmoothScrollTimerTask extends TimerTask {
    ...
    newSmoothScrollTimerTask(newWheelView loopview, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            loopView.handler.sendEmptyMessage(newMessageHandler.WHAT_ITEM_SELECTED);
        } else {
            ...
            loopView.handler.sendEmptyMessage(newMessageHandler.WHAT_INVALIDATE_LOOP_VIEW);
