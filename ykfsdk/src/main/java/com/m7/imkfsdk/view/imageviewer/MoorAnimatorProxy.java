...
public final class MoorAnimatorProxy extends Animation {
    ...
    private static final WeakHashMap<View, MoorAnimatorProxy> PROXIES = new WeakHashMap<View, MoorAnimatorProxy>();
