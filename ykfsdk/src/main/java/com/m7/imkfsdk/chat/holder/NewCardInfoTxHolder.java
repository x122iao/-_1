...
public class NewCardInfoTxHolder extends BaseHolder {
    ...
    public BaseHolder initBaseHolder(View baseView, boolean isReceive) {
        ...
        iv_order_img = baseView.findViewById(R.id.iv_order_img);
        tv_order_title = baseView.findViewById(R.id.tv_order_title);
        tv_order_ = baseView.findViewById(R.id.tv_order_);
        tv_send_order = baseView.findViewById(R.id.tv_send_order);
        ll_order_main = baseView.findViewById(R.id.ll_order_main);
        return this;
    }
