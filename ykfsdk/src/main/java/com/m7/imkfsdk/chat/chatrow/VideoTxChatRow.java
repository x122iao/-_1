...
public class VideoTxChatRow extends BaseChatRow {
    ...
    protected void buildChattingData(Context context, BaseHolder baseHolder, FromToMessage detail, int position) {
        ...
        if(message != null) {
            ...
            if("Hangup".equals(NullUtil.checkNull(message.videoStatus)) || "hangup".equals(NullUtil.checkNull(message.videoStatus))) {
                ...
                holder.getDescTextView().setTextColor(context.getResources().getColor(R.color.ykfsdk_all_white));
                holder.getVideoIcon().setImageResource(R.drawable.ykfsdk_chatrow_video_red);
    ...
    public View buildChatView(LayoutInflater inflater, View convertView) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.ykfsdk_kf_chat_row_video_tx, null);
