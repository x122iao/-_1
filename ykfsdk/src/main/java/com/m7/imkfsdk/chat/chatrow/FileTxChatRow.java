...
public class FileTxChatRow extends BaseChatRow {
    ...
    protected void buildChattingData(final Context context, BaseHolder baseHolder, FromToMessage detail, int position) {
        ...
        if (message != null) {
            ...
            if ("true".equals(message.sendState)) {
                holder.getChat_content_tv_status().setText("/"+context.getResources().getString(R.string.ykfsdk_sended));
                ...
                holder.getChat_content_tv_status().setText("/" + context.getResources().getString(R.string.ykfsdk_upload_fail));
            } else {
                holder.getChat_content_pb_progress().setVisibility(View.VISIBLE);
            }
        }
    ...
    public View buildChatView(LayoutInflater inflater, View convertView) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.ykfsdk_kf_chat_row_file_tx, null);
