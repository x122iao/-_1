    ...
    public void onClick(View v) {
        ...
        switch (holder.type) {
            ...
            case ViewHolderTag.TagType.TAG_CLICK_LOGISTICS_PROGERSS_MORE:
                ...
                break;
            case ViewHolderTag.TagType.TAG_CLICK_SHOW_INVESTIGATECANCEL:
                mContext.dealCancelInvestigateClick(holder.detail);
                break;
            case ViewHolderTag.TagType.TAG_CLICK_SHOW_TAB_QUESTIONMORE:
                mContext.handleTab_QusetionMoreClick(holder.tabtitle,holder.tabquestions);
