...
public class TextTxChatRow extends BaseChatRow {
    ...
    protected void buildChattingData(Context context, BaseHolder baseHolder, FromToMessage detail, int position) {
        ...
        if (message != null) {
            ...
            while (matcher2.find()) {
                ...
                ForegroundColorSpan colorSpan = new ForegroundColorSpan(context.getResources().getColor(R.color.ykfsdk_startcolor));
    ...
    public View buildChatView(LayoutInflater inflater, View convertView) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.ykfsdk_kf_chat_row_text_tx, null);
