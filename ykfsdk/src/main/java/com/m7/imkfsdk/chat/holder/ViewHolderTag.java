...
public class ViewHolderTag {
    ...
    public ArrayList<String> tabquestions;//常见问题分组数据
    public String tabtitle;//常见问题分组标题
    ...
    //分组常见问题 查看更多
    public static ViewHolderTag createTag(String tabtitle,ArrayList<String> tabquestions,int type) {
        ViewHolderTag holderTag = new ViewHolderTag();
        holderTag.type = type;
        holderTag.tabquestions=tabquestions;
        holderTag.tabtitle=tabtitle;
        return holderTag;
    }
    ...
    public static class TagType {
        ...
        public static final int TAG_CLICK_SHOW_INVESTIGATECANCEL = 15;//显示评价弹框
        public static final int TAG_CLICK_SHOW_TAB_QUESTIONMORE = 16;//分组常见问题 查看更多
    }
}
