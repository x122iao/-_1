...
import com.tongshang.cloudphone.databinding.FragmentFoundationBinding
import com.tongshang.cloudphone.ui.adapter.FoundAdapter
...
class FoundationFragment : BaseFragment() {
    ...
    private lateinit var _binding: FragmentFoundationBinding
    ...
    override fun initView(rootView: View) {
        // 初始化 ViewBinding
        _binding = FragmentFoundationBinding.bind(rootView)
        ...
        _binding.recy.adapter = FoundAdapter(itemList)
