...
import com.tongshang.cloudphone.databinding.FragmentSeniorBinding
import com.tongshang.cloudphone.ui.adapter.SeniorAdapter
...
class SeniorFragment : BaseFragment() {

    private lateinit var _binding: FragmentSeniorBinding
    ...
    override fun initView(rootView: View) {
        // 初始化 ViewBinding
        _binding = FragmentSeniorBinding.bind(rootView)

        icon(false)
        iconImage(R.mipmap.senior_1)
        ...
        _binding.recy.adapter = SeniorAdapter(itemList)
