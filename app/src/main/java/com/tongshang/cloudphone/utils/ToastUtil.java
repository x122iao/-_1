...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(MyApplication.Companion.getApplication() != null){
            if (toast == null) {
                toast = Toast.makeText(MyApplication.Companion.getApplication(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            toast.show();
    ...
    public static void showLongToast(String msg) {
        if(MyApplication.Companion.getApplication() != null) {
            if (toast == null) {
                toast = Toast.makeText(MyApplication.Companion.getApplication(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.show();
